function writeManifest() {
    ...
    !1 === t ? (q.style.display = "none", n = new uuid_generator_class, a = {
        ...
        d.header.version, n.checked && a.checked && (d.capabilities = [], d.capabilities[0] = "experimental_custom_ui"), document.getElementById("bp.gametest.checkbox").checked ? (document.getElementById("bp.gametest.element").style.display = "block", b.dependencies[0] = {}, b.dependencies[0].description = "Minecraft module, required to use the Minecraft module", b.dependencies[0].uuid = "b26a4d4c-afdf-4690-88f8-931846312678", b.dependencies[0].version = [0, 1, 0], b.dependencies[1] = {}, b.dependencies[1].description = "GameTest module, required to use the GameTest module",
            b.dependencies[1].uuid = "6f4b6893-1bb6-42fd-b458-7fa3d0c89616", b.dependencies[1].version = [0, 1, 0], a.checked ? (b.modules[2] = {}, b.modules[2].type = "javascript", b.modules[2].uuid = l.generate_uuid(), b.modules[2].version = [1, 0, 0], b.modules[2].entry = "scripts/" + document.getElementById("bp.gametest.file").value) : (b.modules[1] = {}, b.modules[1].type = "javascript", b.modules[1].uuid = l.generate_uuid(), b.modules[1].version = [1, 0, 0], b.modules[1].entry = "scripts/" + document.getElementById("bp.gametest.file").value)) : document.getElementById("bp.gametest.element").style.display =
