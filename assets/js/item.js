...
function writeItem() {
  ...
  a["minecraft:item"].components["minecraft:stacked_by_data"] = stackedData.checked;
  handEquipped.checked && (a["minecraft:item"].components["minecraft:hand_equipped"] = handEquipped.checked);
  destroyInC.checked && (a["minecraft:item"].components["minecraft:can_destroy_in_creative"] = destroyInC.checked);
  ccategoryCheckbox.checked ?
    (ccategory.disabled = !1, a["minecraft:item"].components["minecraft:creative_category"] = {}, "none" !== ccategory.value && (a["minecraft:item"].components["minecraft:creative_category"].parent = ccategory.value)) : ccategory.disabled = !0;
  foodCheckbox.checked ? (foodPanel.style.display = "block", a["minecraft:item"].components["minecraft:food"] = {}, "" !== foodNutr.value && (a["minecraft:item"].components["minecraft:food"].nutrition = parseFloat(foodNutr.value)), "" !== foodSatu.value && (a["minecraft:item"].components["minecraft:food"].saturation_modifier =
    foodSatu.value), a["minecraft:item"].components["minecraft:food"].can_always_eat = foodCanA.checked, "" !== foodConvert.value && (a["minecraft:item"].components["minecraft:food"].using_converts_to = foodConvert.value)) : foodPanel.style.display = "none";
  ...
  cooldownCheckbox.checked ? (cooldownPanel.style.display = "block", a["minecraft:item"].components["minecraft:cooldown"] = {}, "" !== cooldownCategory.value &&
    (a["minecraft:item"].components["minecraft:cooldown"].category = cooldownCategory.value), "" !== cooldownDuration.value && 0 <= cooldownDuration.value && (a["minecraft:item"].components["minecraft:cooldown"].duration = parseFloat(cooldownDuration.value))) : cooldownPanel.style.display = "none";
  ...
  entityPlacerCheckbox.checked ? (entityPlacerPanel.style.display = "block", a["minecraft:item"].components["minecraft:entity_placer"] = {}, "" !== entityPlacerEntity.value && (a["minecraft:item"].components["minecraft:entity_placer"].entity =
    entityPlacerEntity.value), "" !== entityPlacerUseon.value && (a["minecraft:item"].components["minecraft:entity_placer"].use_on = [], a["minecraft:item"].components["minecraft:entity_placer"].use_on = entityPlacerUseon.value.split(",")), "" !== entityPlacerDison.value && (a["minecraft:item"].components["minecraft:entity_placer"].dispense_on = [], a["minecraft:item"].components["minecraft:entity_placer"].dispense_on = entityPlacerDison.value.split(","))) : entityPlacerPanel.style.display = "none";
  enchantableCheckbox.checked ?
    (enchantablePanel.style.display = "block", a["minecraft:item"].components["minecraft:enchantable"] = {}, "none" !== enchantableSlot.value && (a["minecraft:item"].components["minecraft:enchantable"].slot = enchantableSlot.value), "" !== enchantableValue.value && 0 <= enchantableValue.value && (a["minecraft:item"].components["minecraft:enchantable"].value = parseInt(enchantableValue.value))) : enchantablePanel.style.display = "none";
  shooterCheckbox.checked ? (shooterPanel.style.display = "block", a["minecraft:item"].components["minecraft:shooter"] = {}, "" !== shooterMaxDraw.value && 1 <= shooterMaxDraw.value && (a["minecraft:item"].components["minecraft:shooter"].max_draw_duration = parseFloat(shooterMaxDraw.value)), a["minecraft:item"].components["minecraft:shooter"].charge_on_draw = shooterCharge.checked, a["minecraft:item"].components["minecraft:shooter"].scale_power_by_draw_duration = shooterScale.checked, shooterAmmoCheckbox.checked ? (shooterAmmoPanel.style.display = "block", a["minecraft:item"].components["minecraft:shooter"].ammunition = [{}], a["minecraft:item"].components["minecraft:shooter"].ammunition[0].search_inventory =
    shooterAmmoInven.checked, "" !== shooterAmmoItem.value && (a["minecraft:item"].components["minecraft:shooter"].ammunition[0].item = shooterAmmoItem.value), a["minecraft:item"].components["minecraft:shooter"].ammunition[0].use_offhad = shooterAmmoHand.checked, a["minecraft:item"].components["minecraft:shooter"].ammunition[0].use_in_creative = shooterAmmoCreative.checked) : shooterAmmoPanel.style.display = "none") : shooterPanel.style.display = "none";
  ...
  shouldDespawn.checked && (a["minecraft:item"].components["minecraft:should_despawn"] =
    shouldDespawn.checked);
  mirroredArt.checked && (a["minecraft:item"].components["minecraft:mirrored_art"] = mirroredArt.checked);
  projectileCheckbox.checked ? (projectilePanel.style.display = "block", a["minecraft:item"].components["minecraft:projectile"] = {}, "" !== projectileEntity.value && (a["minecraft:item"].components["minecraft:projectile"].projectile_entity = projectileEntity.value), "" !== projectilePower.value && (a["minecraft:item"].components["minecraft:projectile"].minimum_critical_power = parseFloat(projectilePower.value))) :
  ...
  download.onclick = function() {
    ...
    b.download =
      identifier.value.split(":")[1] + ".item.json";
    b.innerHTML = "Save";
